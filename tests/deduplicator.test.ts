...
describe("Deduplicator", () => {
  ...
  test('should place informational nodes at the top', () => {
    const infoUri = 'trojan://1@04.49--2026.02.17.time:0449?sni=fake_ip_for_sub_link&security=tls#info';
    const normalUri = 'trojan://60f5d0cb-9e52-4f11-8c56-a362daff5609@example.com:443?security=tls#normal';
